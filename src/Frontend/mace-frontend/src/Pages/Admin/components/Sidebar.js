      ...
      switch (menuName) {
        ...
        case "Financial Planning and Compliance":
          if (subMenuItem === "Planning and Forecasting") {
            ...
            navigate("/Planning-and-Forecasting/*");
            ...
            navigate("/Benefits-and-Compliance/*");
          }
          break;
